...
public final class WiresManager
{
    ...
    public WiresConnectorControl register(final WiresConnector connector)
    {
        ...
        m_registrationManager.register(connector.getGroup().addNodeMouseEnterHandler(handler));
        m_registrationManager.register(connector.getGroup().addNodeMouseExitHandler(handler));
